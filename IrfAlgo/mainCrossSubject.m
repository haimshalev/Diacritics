...
subjects = {'002','003','004','007','008','009','010','011'};
        ...
        for irfFileLengthIdx = 1 : numel(irfFileLengths)              
           ...
           %% Training Mode
            ...
            %% Classification Code
              ...
              [scans, regressors, irfDictionary] = PrapareClassifyRunCrossSubj(subject, run, irfFileLengthFolder, regressorsFolder, scansFolder, maskPath, featuresFolder, irfDictionariesFolder, StatisticsLearningOutputFolderCrossRun);
              ...
              for previousWindowSize = 0 : 0
                  ...
                  for startTr = 1 : 1
                      ...
                      for endTr = size(irfDictionary,2) : size(irfDictionary,2)
                          ...
                          [classificationRes, confusionMatrix] = ClassifyData(scans, regressors, irfDictionary, testedConditions, previousWindowSize, startTr, endTr, ...
                                                                classificationMode, struct('stats', corrects ./ trials, 'numOfTrials', trials));
