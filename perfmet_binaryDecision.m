function [perfmet] = perfmet_binaryDecision(acts,targs,scratchpad,varargin)
% This is the most basic performance metric.
%
% [PERFMET] = PERFMET_MAXCLASS(ACTS,TARGS,SCRATCHPAD,...)
%
% The classifier is considered to guess correctly if its returned value after threshold equals to the value of the target
%
% ACTS = 1 x nTimepoints
%
% TARGS = 1 x nTimepoints
%
